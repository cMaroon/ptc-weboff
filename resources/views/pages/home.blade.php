...
<div class="wrapper row3">
  <div id="introblocks" class="hoc clear"> 
    ...
    <ul class="nospace clear">
      <li>
        <article><i><img src="{{ asset('images/logo_bsit.png') }}" alt="PTC-LOGO"></i><br>
      ...
      <li>
        <article><i><img src="{{ asset('images/logo_bsoa.png') }}" alt="PTC-LOGO"></i><br>
      ...
      <li>
        <article><i><img src="{{ asset('images/logo_chrm.png') }}" alt="PTC-LOGO"></i><br>
      ...
      <li>
        <article><i><img src="{{ asset('images/logo_tesda.png') }}" alt="PTC-LOGO"></i><br>
      ...
      <li>
        <article><i><img src="{{ asset('images/logo_shs.png') }}" alt="PTC-LOGO"></i><br>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="group">
      ...
      <div class="card border-success mb-3" style="max-width: 50rem;">
        <div class="card-header font-x2">Announcements</div>
        <div class="card-body">
          
            <div class="one_half first"><img src="{{ asset('images/announcements/no-image.png') }}" alt=""></div>
